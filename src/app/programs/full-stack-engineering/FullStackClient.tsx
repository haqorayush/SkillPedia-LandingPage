...
const TECH_STACK = [
  { name: 'HTML5 & CSS3', icon: <Layout className="w-6 h-6" />, color: 'text-orange-500' },
  { name: 'JavaScript (ES6+)', icon: <Terminal className="w-6 h-6" />, color: 'text-yellow-400' },
  { name: 'React.js', icon: <Globe className="w-6 h-6" />, color: 'text-blue-400' },
  { name: 'Next.js', icon: <MonitorPlay className="w-6 h-6" />, color: 'text-gray-900 dark:text-white' },
  ...
  { name: 'MongoDB', icon: <Database className="w-6 h-6" />, color: 'text-green-600' },
  { name: 'Docker & AWS', icon: <Cpu className="w-6 h-6" />, color: 'text-orange-600' },
];

const CURRICULUM = [
  {
    month: "Month 1",
    title: "Frontend Fundamentals & Modern UI",
    description: "Build a strong foundation in modern web design and interactive user interfaces.",
    topics: [
      "Semantic HTML5 & Modern CSS3 (Flexbox/Grid)",
      "Advanced JavaScript (ES6+, Async/Await, DOM)",
      "Responsive Web Design & Mobile-First Approach",
      "React.js Core Concepts (Hooks, State, Props)",
      "Tailwind CSS for Rapid UI Development",
      "Project: Interactive E-commerce Frontend"
    ]
  },
  {
    month: "Month 2",
    title: "Advanced Frontend & Backend Intro",
    description: "Scale your applications with robust frameworks and server-side logic.",
    topics: [
      "Next.js App Router & Server Components",
      "TypeScript integration for type safety",
      "State Management (Zustand/Redux)",
      "Node.js & Express.js server creation",
      "RESTful API design and implementation",
      "Project: Full-stack Social Dashboard"
    ]
  },
  {
    month: "Month 3",
    title: "Databases, Deployment & Career Prep",
    description: "Master data management, cloud deployment, and ace your technical interviews.",
    topics: [
      "Relational & NoSQL Databases (PostgreSQL, MongoDB)",
      "Authentication & Security (JWT, OAuth)",
      "Docker basics and Vercel/AWS Deployments",
      ...
      "Final Capstone Project & Portfolio creation"
    ]
  }
];
    ...
    <main className="min-h-screen bg-white dark:bg-[#071340]">
      ...
      <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <div className="absolute inset-0 bg-gradient-to-br from-blue-50 to-white dark:from-[#0B1F5E] dark:to-[#071340]" />
          <motion.div 
            style={{ y, opacity }}
            className="absolute -top-[20%] -right-[10%] w-[70vw] h-[70vw] rounded-full bg-blue-400/10 dark:bg-blue-600/20 blur-[100px] pointer-events-none"
          />
          <motion.div 
            style={{ y: useTransform(scrollYProgress, [0, 1], [0, -200]) }}
            className="absolute -bottom-[20%] -left-[10%] w-[50vw] h-[50vw] rounded-full bg-orange-400/10 dark:bg-orange-600/20 blur-[100px] pointer-events-none"
          />
        </div>
        ...
        <div className="container relative z-10 mx-auto px-6 max-w-6xl">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 text-sm font-semibold mb-6">
              ...
              <span>Premium Engineering Program</span>
            </div>
            ...
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-gray-900 dark:text-white mb-6 tracking-tight leading-tight font-[family-name:var(--font-heading)]">
              Master <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-cyan-500">Full Stack</span> <br className="hidden md:block" />
              Engineering
            </h1>
            
            <p className="text-lg md:text-xl text-gray-600 dark:text-gray-300 mb-10 max-w-2xl mx-auto leading-relaxed">
              Build scalable web applications from scratch using the latest in-demand tools. Learn modern web development, deploy production-ready apps, and land your dream job.
            </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {TECH_STACK.map((tech, index) => (
              <motion.div
                ...
                className="flex items-center gap-4 p-6 bg-white dark:bg-white/5 rounded-2xl border border-gray-100 dark:border-white/10 hover:shadow-xl dark:hover:shadow-blue-500/10 transition-all group"
              >
      ...
      <section id="curriculum" className="py-24">
        <div className="container mx-auto px-6 max-w-4xl">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 dark:text-gray-400 text-lg">A comprehensive journey from basics to advanced engineering.</p>
          </div>
          ...
          <div className="space-y-8">
            {CURRICULUM.map((module, index) => (
              ...
              >
                ...
                <div className="absolute left-0 top-0 bottom-0 w-px bg-blue-200 dark:bg-blue-800 md:hidden" />
      ...
      <section className="py-24 bg-gray-50 dark:bg-[#0B1F5E]/30">
        <div className="container mx-auto px-6 max-w-6xl">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 dark:text-gray-400">Taught by engineers who build production software daily.</p>
          </div>
      ...
      <section className="py-24 relative overflow-hidden">
        <div className="absolute inset-0 bg-blue-600 dark:bg-[#0B1F5E]" />
        ...
        <div className="container relative z-10 mx-auto px-6 max-w-4xl text-center">
          ...
          <p className="text-blue-100 text-lg md:text-xl mb-10 max-w-2xl mx-auto">
            Join the next cohort of Full Stack Engineering. Seats are extremely limited to ensure 1-on-1 mentorship.
          </p>
          <Link 
            href="/apply" 
            className="inline-flex items-center gap-2 px-10 py-5 rounded-full bg-white text-blue-600 font-bold text-lg hover:scale-105 transition-transform shadow-xl"
          >
            Apply Now
